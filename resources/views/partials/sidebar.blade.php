<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->is('data_jurusan') || request()->is('data_siswa') || request()->is('data_budaya_positif') || request()->is('data_prestasi') || request()->is('data_pelanggaran') ? 'active' : 'collapsed' }}" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-menu-button-wide"></i><span>Data Master</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="components-nav" class="nav-content {{ request()->is('data_jurusan') || request()->is('data_siswa') || request()->is('data_budaya_positif') || request()->is('data_prestasi') || request()->is('data_pelanggaran') ? 'collapse show' : 'collapse' }}" data-bs-parent="#sidebar-nav">
                <li>
        ...
        <li class="nav-item">
            ...
            <ul id="tables-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('user.index', 'admin') }}" class="{{ request()->route('role') == 'admin' ? 'active' : 'collapsed' }}">
                        <i class="bi bi-circle"></i><span>User Admin</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user.index', 'guru') }}" class="{{ request()->route('role') == 'guru' ? 'active' : 'collapsed' }}">
                        <i class="bi bi-circle"></i><span>User Guru</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user.index', 'siswa') }}" class="{{ request()->route('role') == 'siswa' ? 'active' : 'collapsed' }}">
